...
const { falNanaBanana } = await import("../lib/round1-v2/providers/fal-nano-banana");
...
const rebuildResult = await runRebuildBatch(brief, selection.selected, falNanaBananaPro, falNanaBanana);
